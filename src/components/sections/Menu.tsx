...
const Menu = () => {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-gradient-to-b from-gold-500 pb-[90px] transition-all duration-300 dark:from-gray-950">
      <a
        href={githubLink}
        className="group absolute left-0 scale-x-[-1] scale-y-[1] fill-gray-950 text-white hover:fill-black"
        target="_blank"
      ...
      >
        ...
        >
          ...
          <path
            ...
            className="group-hover:animate-octo-arm"
          />
          <path
            ...
            {navLinks.map((link) => (
              <li key={link.to}>
                <ScrollLink
                  ...
                  smooth={true}
                  duration={500}
                  className="inline-block cursor-pointer py-6"
                  onClick={handleMenuToggle}
                >
                  {link.label}
                </ScrollLink>
